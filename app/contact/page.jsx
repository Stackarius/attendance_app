...
import { LucideTwitter, Linkedin, Twitter, LinkedinIcon, Github, Mail,  } from "lucide-react";
        ...
        <div className="min-h-screen bg-gradient-to-br from-blue-600 via-indigo-700 to-purple-700 text-white">
            ...
            <div className="max-w-6xl mx-auto bg-white shadow-lg rounded-lg flex flex-col lg:flex-row overflow-hidden">
                ...
                <div className="w-full lg:w-1/2 bg-blue-50 p-8 flex flex-col justify-center gap-6">
                    ...
                    <div className="space-y-3 text-gray-900">
                        <p><span className="font-semibold">Email:</span> support@attendance</p>
                    ...
                    <div className="flex gap-4 mt-2 text-blue-600">
                        <a href="https://twitter.com/" target="_blank" rel="noopener noreferrer" className="hover:text-blue-800 transition-colors"><Twitter size={24} /></a>
                        <a href="https://linkedin.com/" target="_blank" rel="noopener noreferrer" className="hover:text-blue-800 transition-colors"><LinkedinIcon size={24} /></a>
                        <a href="https://github.com/" target="_blank" rel="noopener noreferrer" className="hover:text-blue-800 transition-colors"><Github size={24} /></a>
                        <a href="mailto:developer@example.com" className="hover:text-blue-800 transition-colors"><Mail size={24} /></a>
                    </div>
            ...
            <div className="max-w-6xl mx-auto my-12 bg-white shadow-lg rounded-lg p-8 py-12 text-center">
                ...
                <div className="flex justify-center gap-6 text-blue-600">
                    <a href="https://twitter.com/Stackarius" target="_blank" rel="noopener noreferrer" className="hover:text-blue-800 transition-colors"><Twitter size={28} /></a>
                    <a href="https://github.com/Stackarius" target="_blank" rel="noopener noreferrer" className="hover:text-blue-800 transition-colors"><Github size={28} /></a>
                    <a href="mailto:opepoju@gmail.com" className="hover:text-blue-800 transition-colors"><Mail size={28} /></a>
                </div>
            </div>
